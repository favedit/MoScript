with(MO){
   ...
   MO.FUiDataNumber2 = function FUiDataNumber2(o){
      //o = MO.Class.inherits(this, o, FDuiNumber2, MDescNumber, MEditBorder, MListView, MZoom, MMouseWheel);
      ...
      //..........................................................
      // @event
      //o.onEditFocus       = MO.Class.register(o, new HFocus('onEditFocus'), FUiDataNumber2_onEditFocus);
      //o.onEditBlur        = MO.Class.register(o, new HBlur('onEditBlur'), FUiDataNumber2_onEditBlur);
