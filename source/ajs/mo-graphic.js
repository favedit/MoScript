...
MO.Graphic3d = new function Graphic3dSpace(){
   return this;
}
...
MO.Graphic3d.MG3dRenderable = function MG3dRenderable(o){
   o = RClass.inherits(this, o, MO.Graphic3d.MGraphicRenderable);
...
MO.Graphic3d.SG3dEffectInfo = function SG3dEffectInfo(){
   var o = this;
   o.code                  = null;
...
MO.Graphic3d.FG3dAnimation = function FG3dAnimation(o){
...
MO.Graphic3d.FG3dCamera = function FG3dCamera(o){
   o = RClass.inherits(this, o, MO.FObject);
   o._matrix          = null;
   o._position        = null;
   o._target          = null;
...
MO.Graphic3d.FG3dDirectionalLight = function FG3dDirectionalLight(o){
   o = RClass.inherits(this, o, MO.Graphic3d.FG3dLight);
   o._camera     = null;
   o._viewport   = null;
   o._direction  = null;
...
MO.Graphic3d.FG3dEffect = function FG3dEffect(o){
   o = RClass.inherits(this, o, MO.Graphic3d.FG3dObject);
   o._code               = null;
   o._stateFillCd        = MO.Graphic3d.EG3dFillMode.Face;
   o._stateCullCd        = MO.Graphic3d.EG3dCullMode.Front;
   o._stateDepth         = true;
   o._stateDepthCd       = MO.Graphic3d.EG3dDepthMode.LessEqual;
   o._stateDepthWrite    = true;
   o._stateBlend         = true;
   o._stateBlendSourceCd = MO.Graphic3d.EG3dBlendMode.SourceAlpha;
   o._stateBlendTargetCd = MO.Graphic3d.EG3dBlendMode.OneMinusSourceAlpha;
   ...
   function FG3dEffect_loadUrl(u){
      var o = this;
      var x = RClass.create(MO.FXmlConnection);
      if(RRuntime.isDebug()){
         u += '?' + RDate.format();
      }
      var r = x.send(u);
   ...
   function FG3dEffect_build(p){
      var o = this;
      var g = o._program;
      var c = RInstance.get(MO.FTagContext);
      o.buildInfo(c, p);
   ...
   function FG3dEffect_load(){
      ...
      var ec = RConsole.find(MO.Graphic3d.FG3dEffectConsole);
...
MO.Graphic3d.FG3dEffectConsole = function FG3dEffectConsole(o){
...
MO.Graphic3d.FG3dMaterialMap = function FG3dMaterialMap(o){
   o = RClass.inherits(this, o, MO.FObject, MO.Graphic.MGraphicObject);
   o._size      = null;
   o._data      = null;
   o._texture   = null;
   o._stride    = null;
...
MO.Graphic3d.FG3dOrthoProjection = function FG3dOrthoProjection(o){
   o = RClass.inherits(this, o, MO.Graphic3d.FG3dProjection);
   o._matrix       = null;
...
MO.Graphic3d.FG3dPerspectiveCamera = function FG3dPerspectiveCamera(o){
...
MO.Graphic3d.FG3dPerspectiveProjection = function FG3dPerspectiveProjection(o){
   o = RClass.inherits(this, o, MO.Graphic3d.FG3dProjection);
   o._matrix       = null;
...
MO.Graphic3d.FG3dRegion = function FG3dRegion(o){
   o = RClass.inherits(this, o, FObject, MO.Graphic.MGraphicObject);
   o._spaceName                  = null;
   o._technique                  = null;
...
MO.Graphic3d.FG3dSpotLight = function FG3dSpotLight(o){
   o = RClass.inherits(this, o, MO.Graphic3d.FG3dLight);
   return o;
}
MO.Graphic3d.FG3dTechnique = function FG3dTechnique(o){
   o = RClass.inherits(this, o, MO.Graphic3d.FG3dObject);
   o._code           = null;
   o._activeMode     = null;
   o._modes          = null;
...
MO.Graphic3d.FG3dTechniqueConsole = function FG3dTechniqueConsole(o){
   o = RClass.inherits(this, o, MO.FConsole);
   o._techniques = null;
...
MO.Graphic3d.FG3dTrack = function FG3dTrack(o){
   o = RClass.inherits(this, o, MO.FObject);
   o._frames = null;
...
MO.Graphic3d.EG3dSampler = new function EG3dSampler(){
   var o = this;
   o.Diffuse       = 'diffuse';
   o.Alpha         = 'alpha';
   o.Normal        = 'normal';
...
MO.Graphic3d.EG3dTexture = new function EG3dTexture(){
   var o = this;
   o.Unknown = 0;
   o.Flat2d = 1;
   o.Flat3d = 2;
...
MO.Graphic3d.SG3dContextCapability = function SG3dContextCapability(){
   var o = this;
   o.vendor                 = null;
   o.version                = null;
...
MO.Graphic3d.FG3dIndexBuffer = function FG3dIndexBuffer(o){
   o = RClass.inherits(this, o, FG3dObject);
   o._strideCd = MO.Graphic3d.EG3dIndexStride.Uint16;
   o._count    = 0;
...
MO.Graphic3d.FG3dProgram = function FG3dProgram(o){
   o = RClass.inherits(this, o, MO.Graphic3d.FG3dObject);
   o._attributes       = null;
   o._parameters       = null;
   o._samplers         = null;
...
MO.Graphic3d.FG3dProgramAttribute = function FG3dProgramAttribute(o){
   o = RClass.inherits(this, o, MO.FObject);
   o._name       = null;
   o._linker     = null;
   o._statusUsed = false;
...
MO.Graphic3d.FG3dRenderTarget = function FG3dRenderTarget(o){
   o = RClass.inherits(this, o, MO.Graphic3d.FG3dObject);
   o._size     = null;
   o._color    = null;
   o._textures = null;
...
MO.Graphic3d.FG3dTexture = function FG3dTexture(o){
   o = RClass.inherits(this, o, MO.Graphic3d.FG3dObject);
   o._textureCd   = MO.Graphic3d.EG3dTexture.Unknown;
   o._statusLoad  = false;
...
MO.Graphic3d.FG3dAutomaticEffect = function FG3dAutomaticEffect(o){
   o = RClass.inherits(this, o, MO.Graphic3d.FG3dEffect);
...
MO.Graphic3d.FG3dControlAutomaticEffect = function FG3dControlAutomaticEffect(o){
...
MO.Graphic3d.FG3dControlFrameEffect = function FG3dControlFrameEffect(o){
   o = RClass.inherits(this, o, MO.Graphic3d.FG3dAutomaticEffect);
...
MO.Graphic3d.FG3dGeneralColorSkeletonEffect = function FG3dGeneralColorSkeletonEffect(o){
   o = RClass.inherits(this, o, MO.Graphic3d.FG3dAutomaticEffect);
...
MO.Graphic3d.FG3dSelectPass = function FG3dSelectPass(o){
   o = RClass.inherits(this, o, MO.Graphic3d.FG3dTechniquePass);
   o._code         = 'select';
   o._texture      = null;
...
MO.Graphic3d.FG3dSelectSkeletonEffect = function FG3dSelectSkeletonEffect(o){
   o = RClass.inherits(this, o, MO.Graphic3d.FG3dAutomaticEffect);
   o._code          = 'select.automatic';
...
MO.Graphic3d.FG3dSelectTechnique = function FG3dSelectTechnique(o){
   o = RClass.inherits(this, o, MO.Graphic3d.FG3dTechnique);
   o._code       = 'select';
   o._passSelect = null;
...
MO.Graphic3d.FG3dShadowColorAutomaticEffect = function FG3dShadowColorAutomaticEffect(o){
   o = RClass.inherits(this, o, MO.Graphic3d.FG3dAutomaticEffect);
...
MO.Graphic3d.FG3dShadowColorPass = function FG3dShadowColorPass(o){
   o = RClass.inherits(this, o, MO.Graphic3d.FG3dTechniquePass);
   o._code           = 'color';
...
MO.Graphic3d.FG3dShadowColorSkeletonEffect = function FG3dShadowColorSkeletonEffect(o){
   o = RClass.inherits(this, o, MO.Graphic3d.FG3dAutomaticEffect);
...
MO.Graphic3d.FG3dShadowDepthAutomaticEffect = function FG3dShadowDepthAutomaticEffect(o){
   o = RClass.inherits(this, o, MO.Graphic3d.FG3dAutomaticEffect);
...
MO.Graphic3d.FG3dShadowDepthPass = function FG3dShadowDepthPass(o){
   o = RClass.inherits(this, o, MO.Graphic3d.FG3dTechniquePass);
   o._code         = 'depth';
   o._renderTarget = null;
   o._textureDepth = null;
...
MO.Graphic3d.FG3dShadowDepthSkeletonEffect = function FG3dShadowDepthSkeletonEffect(o){
   o = RClass.inherits(this, o, MO.Graphic3d.FG3dAutomaticEffect);
...
MO.Graphic3d.FG3dShadowTechnique = function FG3dShadowTechnique(o){
   o = RClass.inherits(this, o, MO.Graphic3d.FG3dTechnique);
   o._code        = 'shadow';
   o._passDepth   = null;
   o._passColor   = null;
