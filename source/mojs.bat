...
@"%JAVA_HOME%\bin\java.exe" -cp %JAVA_PATH% %JAVA_PMGR% %JS_HOME%\4.2.2-control-table      %JS_HOME%\ajs\control-table.js      N
@"%JAVA_HOME%\bin\java.exe" -cp %JAVA_PATH% %JAVA_PMGR% %JS_HOME%\4.3.1-control-menu       %JS_HOME%\ajs\control-menu.js       N
@"%JAVA_HOME%\bin\java.exe" -cp %JAVA_PATH% %JAVA_PMGR% %JS_HOME%\4.3.2-control-tool       %JS_HOME%\ajs\control-tool.js       N
@"%JAVA_HOME%\bin\java.exe" -cp %JAVA_PATH% %JAVA_PMGR% %JS_HOME%\4.3.3-control-tree       %JS_HOME%\ajs\control-tree.js       N
@"%JAVA_HOME%\bin\java.exe" -cp %JAVA_PATH% %JAVA_PMGR% %JS_HOME%\4.3.4-control-page       %JS_HOME%\ajs\control-page.js       N
@"%JAVA_HOME%\bin\java.exe" -cp %JAVA_PATH% %JAVA_PMGR% %JS_HOME%\4.3.5-control-frame      %JS_HOME%\ajs\control-frame.js      N
...
@SET JS_FILES=%JS_FILES% %JS_HOME%\ajs\control-menu.js
@SET JS_FILES=%JS_FILES% %JS_HOME%\ajs\control-tool.js
@SET JS_FILES=%JS_FILES% %JS_HOME%\ajs\control-page.js
@SET JS_FILES=%JS_FILES% %JS_HOME%\ajs\control-tree.js
@SET JS_FILES=%JS_FILES% %JS_HOME%\ajs\control-frame.js
