...
// @history 151107
//==========================================================
MO.FEaiCockpitAchievementDaySnapshot = function FEaiCockpitAchievementDaySnapshot(o) {
   ...
   //..........................................................
   // @event
   o.onDataFetch           = MO.FEaiCockpitAchievementDaySnapshot_onDataFetch;
   o.onPaintBegin          = MO.FEaiCockpitAchievementDaySnapshot_onPaintBegin;
   o.onPaintEnd            = MO.FEaiCockpitAchievementDaySnapshot_onPaintEnd;
   //..........................................................
   // @method
   o.construct             = MO.FEaiCockpitAchievementDaySnapshot_construct;
   // @method
   o.setup                 = MO.FEaiCockpitAchievementDaySnapshot_setup;
   o.setData               = MO.FEaiCockpitAchievementDaySnapshot_setData;
   o.roll                  = MO.FEaiCockpitAchievementDaySnapshot_roll;
   o.nextPage              = MO.FEaiCockpitAchievementDaySnapshot_nextPage;
   o.processLogic          = MO.FEaiCockpitAchievementDaySnapshot_processLogic;
   o.selectedIndex         = MO.FEaiCockpitAchievementDaySnapshot_selectedIndex;
   o.showChart             = MO.FEaiCockpitAchievementDaySnapshot_showChart;
   // @method
   o.dispose               = MO.FEaiCockpitAchievementDaySnapshot_dispose;
   //..........................................................
...
//==========================================================
 MO.FEaiCockpitAchievementDaySnapshot_onDataFetch = function FEaiCockpitAchievementDaySnapshot_onDataFetch(event){
   var o = this;
...
// @method
//==========================================================
MO.FEaiCockpitAchievementDaySnapshot_onPaintBegin = function FEaiCockpitAchievementDaySnapshot_onPaintBegin(event) {
   var o = this;
...
// @method
//==========================================================
MO.FEaiCockpitAchievementDaySnapshot_onPaintEnd = function FEaiCockpitAchievementDaySnapshot_onPaintEnd(event) {
   var o = this;
...
// @method
//==========================================================
MO.FEaiCockpitAchievementDaySnapshot_construct = function FEaiCockpitAchievementDaySnapshot_construct() {
   var o = this;
...
// @method
//==========================================================
MO.FEaiCockpitAchievementDaySnapshot_setup = function FEaiCockpitAchievementDaySnapshot_setup(){
   var o = this;
   // 加载图片
...
// @method
//==========================================================
MO.FEaiCockpitAchievementDaySnapshot_setData = function FEaiCockpitAchievementDaySnapshot_setData(){
   var o = this;
   var data = o._data;
...
// @method
//==========================================================
MO.FEaiCockpitAchievementDaySnapshot_roll = function FEaiCockpitAchievementDaySnapshot_roll() {
   var o = this;
...
// @method
//==========================================================
MO.FEaiCockpitAchievementDaySnapshot_nextPage = function FEaiCockpitAchievementDaySnapshot_nextPage() {
   var o = this;
   o._page ++;
...
// @method
//==========================================================
MO.FEaiCockpitAchievementDaySnapshot_selectedIndex = function FEaiCockpitAchievementDaySnapshot_selectedIndex() {
   var o = this;
...
// @method
//==========================================================
MO.FEaiCockpitAchievementDaySnapshot_processLogic = function FEaiCockpitAchievementDaySnapshot_processLogic(){
   var o = this;
...
// @method
//==========================================================
MO.FEaiCockpitAchievementDaySnapshot_showChart = function FEaiCockpitAchievementDaySnapshot_showChart() {
   var o = this;
...
// @method
//==========================================================
MO.FEaiCockpitAchievementDaySnapshot_dispose = function FEaiCockpitAchievementDaySnapshot_dispose() {
   var o = this;
   // 释放属性
