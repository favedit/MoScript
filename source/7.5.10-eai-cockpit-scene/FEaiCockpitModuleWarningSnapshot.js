...
MO.FEaiCockpitModuleWarningSnapshot = function FEaiCockpitModuleWarningSnapshot(o) {
   ...
   o.setRankUnits          = MO.FEaiCockpitModuleWarningSnapshot_setRankUnits;
   o.pushUnit              = MO.FEaiCockpitModuleWarningSnapshot_pushUnit;
   o.drawRow               = MO.FEaiCockpitModuleWarningSnapshot_drawRow;
   // @method
...
// @param unit:
//==========================================================
MO.FEaiCockpitModuleWarningSnapshot_setRankUnits = function FEaiCockpitModuleWarningSnapshot_setRankUnits(units) {
   var o = this;
...
// @param unit:
//==========================================================
MO.FEaiCockpitModuleWarningSnapshot_pushUnit = function FEaiCockpitModuleWarningSnapshot_pushUnit(unit) {
   var o = this;
   // 检查参数
   if (!unit) {
      return null;
