...
MO.FEaiCockpitModuleTitleSnapshot = function FEaiCockpitModuleTitleSnapshot(o) {
   ...
   o.setRankUnits          = MO.FEaiCockpitModuleTitleSnapshot_setRankUnits;
   o.pushUnit              = MO.FEaiCockpitModuleTitleSnapshot_pushUnit;
   o.drawRow               = MO.FEaiCockpitModuleTitleSnapshot_drawRow;
   // @method
...
// @param unit:
//==========================================================
MO.FEaiCockpitModuleTitleSnapshot_setRankUnits = function FEaiCockpitModuleTitleSnapshot_setRankUnits(units) {
   var o = this;
...
// @param unit:
//==========================================================
MO.FEaiCockpitModuleTitleSnapshot_pushUnit = function FEaiCockpitModuleTitleSnapshot_pushUnit(unit) {
   var o = this;
   // 检查参数
   if (!unit) {
      return null;
