...
MO.FEaiCockpitModuleStatusSnapshot = function FEaiCockpitModuleStatusSnapshot(o) {
   ...
   o.setRankUnits          = MO.FEaiCockpitModuleStatusSnapshot_setRankUnits;
   o.pushUnit              = MO.FEaiCockpitModuleStatusSnapshot_pushUnit;
   o.drawRow               = MO.FEaiCockpitModuleStatusSnapshot_drawRow;
   // @method
...
// @param unit:
//==========================================================
MO.FEaiCockpitModuleStatusSnapshot_setRankUnits = function FEaiCockpitModuleStatusSnapshot_setRankUnits(units) {
   var o = this;
...
// @param unit:
//==========================================================
MO.FEaiCockpitModuleStatusSnapshot_pushUnit = function FEaiCockpitModuleStatusSnapshot_pushUnit(unit) {
   var o = this;
   // 检查参数
   if (!unit) {
      return null;
