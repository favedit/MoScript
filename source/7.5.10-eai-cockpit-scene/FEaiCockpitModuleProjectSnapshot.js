...
MO.FEaiCockpitModuleProjectSnapshot = function FEaiCockpitModuleProjectSnapshot(o) {
   ...
   o.setRankUnits          = MO.FEaiCockpitModuleProjectSnapshot_setRankUnits;
   o.pushUnit              = MO.FEaiCockpitModuleProjectSnapshot_pushUnit;
   o.drawRow               = MO.FEaiCockpitModuleProjectSnapshot_drawRow;
   // @method
...
// @param unit:
//==========================================================
MO.FEaiCockpitModuleProjectSnapshot_setRankUnits = function FEaiCockpitModuleProjectSnapshot_setRankUnits(units) {
   var o = this;
...
// @param unit:
//==========================================================
MO.FEaiCockpitModuleProjectSnapshot_pushUnit = function FEaiCockpitModuleProjectSnapshot_pushUnit(unit) {
   var o = this;
   // 检查参数
   if (!unit) {
      return null;
