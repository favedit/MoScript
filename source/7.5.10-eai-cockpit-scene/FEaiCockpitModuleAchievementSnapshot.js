...
MO.FEaiCockpitModuleAchievementSnapshot = function FEaiCockpitModuleAchievementSnapshot(o) {
   ...
   o.setRankUnits          = MO.FEaiCockpitModuleAchievementSnapshot_setRankUnits;
   o.pushUnit              = MO.FEaiCockpitModuleAchievementSnapshot_pushUnit;
   o.drawRow               = MO.FEaiCockpitModuleAchievementSnapshot_drawRow;
   // @method
...
// @param unit:
//==========================================================
MO.FEaiCockpitModuleAchievementSnapshot_setRankUnits = function FEaiCockpitModuleAchievementSnapshot_setRankUnits(units) {
   var o = this;
...
// @param unit:
//==========================================================
MO.FEaiCockpitModuleAchievementSnapshot_pushUnit = function FEaiCockpitModuleAchievementSnapshot_pushUnit(unit) {
   var o = this;
   // 检查参数
   if (!unit) {
      return null;
