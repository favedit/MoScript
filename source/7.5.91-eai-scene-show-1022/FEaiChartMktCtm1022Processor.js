...
// @history 150619
//==========================================================
MO.FEaiChartMktCtm1022Processor = function FEaiChartMktCtm1022Processor(o){
   ...
   //..........................................................
   // @method
   o.onDynamicData            = MO.FEaiChartMktCtm1022Processor_onDynamicData;
   o.on24HDataFetch           = MO.FEaiChartMktCtm1022Processor_on24HDataFetch;
   //..........................................................
   // @method
   o.construct                = MO.FEaiChartMktCtm1022Processor_construct;
   // @method
   o.allocUnit                = MO.FEaiChartMktCtm1022Processor_allocUnit;
   o.allocShape               = MO.FEaiChartMktCtm1022Processor_allocShape;
   o.setup                    = MO.FEaiChartMktCtm1022Processor_setup;
   // @method
   o.calculateCurrent         = MO.FEaiChartMktCtm1022Processor_calculateCurrent;
   o.focusEntity              = MO.FEaiChartMktCtm1022Processor_focusEntity;
   o.process                  = MO.FEaiChartMktCtm1022Processor_process;
   // @method
   o.dispose                  = MO.FEaiChartMktCtm1022Processor_dispose;
   return o;
}
...
// @method
//==========================================================
MO.FEaiChartMktCtm1022Processor_on24HDataFetch = function FEaiChartMktCtm1022Processor_on24HDataFetch(event) {
   var o = this;
...
// @method
//==========================================================
MO.FEaiChartMktCtm1022Processor_onDynamicData = function FEaiChartMktCtm1022Processor_onDynamicData(event){
   var o = this;
...
// @method
//==========================================================
MO.FEaiChartMktCtm1022Processor_construct = function FEaiChartMktCtm1022Processor_construct(){
   var o = this;
...
//
// @method
// @return FEaiChartMktCtm1022ProcessorEntity 实体
//==========================================================
MO.FEaiChartMktCtm1022Processor_allocUnit = function FEaiChartMktCtm1022Processor_allocUnit(){
   var o = this;
...
// @method
//==========================================================
MO.FEaiChartMktCtm1022Processor_setup = function FEaiChartMktCtm1022Processor_setup(){
   var o = this;
   // 创建声音
...
// @method
//==========================================================
MO.FEaiChartMktCtm1022Processor_calculateCurrent = function FEaiChartMktCtm1022Processor_calculateCurrent(){
   var o = this;
...
// @method
//==========================================================
MO.FEaiChartMktCtm1022Processor_focusEntity = function FEaiChartMktCtm1022Processor_focusEntity(unit){
   var o = this;
...
//==========================================================
MO.FEaiChartMktCtm1022Processor_process = function FEaiChartMktCtm1022Processor_process(){
   var o = this;
   //..........................................................
   // 获得系统时间
...
// @method
//==========================================================
MO.FEaiChartMktCtm1022Processor_dispose = function FEaiChartMktCtm1022Processor_dispose(){
   var o = this;
   // 释放属性
