...
with(MO){
   ...
   MO.FUiPanel = function FUiSelect_onEditEnd(e){
      var o = this;
      if(e){
         o.set(e.get());
         o._invalidText = o.validText(o.text());
   ...
   MO.FUiPanel = function FUiSelect_loadConfig(c){
      var o = this;
   ...
   MO.FUiPanel = function FUiSelect_refreshStyle(){
      var o = this;
   ...
   MO.FUiPanel = function FUiSelect_doBlur(){
      var o = this;
